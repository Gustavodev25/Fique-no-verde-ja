...
// 4. Adição do componente 'App' default.
// O erro 'Element type is invalid' acontece porque o ambiente de
// preview precisa de um 'export default function App()' para renderizar.
export default function App() {
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center gap-4 p-8 bg-gray-900 text-white">
      <h1 className="text-2xl mb-4">Demonstração dos Botões</h1>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <Button variant="secondary" size="icon">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 5v14" /></svg>
        </Button>
